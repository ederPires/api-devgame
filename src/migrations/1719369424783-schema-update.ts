...
export class SchemaUpdate1719369424783 implements MigrationInterface {
    name = 'SchemaUpdate1719369424783'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "game" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "dateRelease" TIMESTAMP NOT NULL, "rating" integer NOT NULL, "site" character varying NOT NULL, "urlImage" character varying NOT NULL, "genreId" uuid, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
